...
private DefaultTableModel TabModel;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Transaksi Beli Barang");
        ...
        jPanel1.add(tambahBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 450, 100, -1));
    ...
    void cetak_nota(){
        try {
            ...
            Connection koneksi = DriverManager.getConnection("jdbc:mysql://localhost/abadisport","root","");
